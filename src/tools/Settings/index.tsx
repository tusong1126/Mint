...
function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="w-12 text-[11px] py-0.5 px-2 rounded-md bg-hover text-text-secondary hover:text-accent transition-colors shrink-0"
    >
      {copied ? "✔" : "复制"}
    </button>
  );
...
function PathRow({ label, path }: { label: string; path: string }) {
  return (
    <div className="flex items-center justify-between py-2">
      <span className="text-sm text-text-primary shrink-0 mr-3">{label}</span>
      <div className="flex items-center gap-2 min-w-0">
        <code className="text-xs text-text-muted truncate max-w-[300px] bg-primary px-2 py-0.5 rounded">{path}</code>
  ...
  return (
    <div className="max-w-[560px] mx-auto">
      <section className="mb-8">
        <h3 className="text-sm font-semibold text-text-muted uppercase tracking-widest mb-3">外观</h3>
      ...
      <section className="mb-8">
        <h3 className="text-sm font-semibold text-text-muted uppercase tracking-widest mb-3">存储</h3>
        <div className="bg-card rounded-lg p-4">
      ...
      <section className="mb-8">
        <h3 className="text-sm font-semibold text-text-muted uppercase tracking-widest mb-3">系统信息</h3>
        <div className="bg-card rounded-lg p-4">
      ...
      <section className="mb-8">
        <h3 className="text-sm font-semibold text-text-muted uppercase tracking-widest mb-3">关于</h3>
        <div className="bg-card rounded-lg p-4">
